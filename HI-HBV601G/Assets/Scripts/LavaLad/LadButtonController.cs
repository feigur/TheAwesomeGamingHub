...
public class LadButtonController : MonoBehaviour
{
    ...
    void DoNotLeaveGame() {
        ...
        playerController playerb = GetComponentInParent<playerController>() as playerController;
        //playerb.LetHimMoveAgain();
    }
